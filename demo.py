...
@author: justjay
"""
#refer to the evaluate.py, modify by Jieli
...
test_label_path = 'data/Annotations/CSIQ/csiq_contrast.txt'
test_img_path = 'data/Imageset/csiq/contrast/'
prewitt_img_path = './data/Imageset/csiq/prewitt_images/contrast/'        #path to gradient image
saliency_img_path = './data/Imageset/csiq/saliency_images/contrast/'      #path to saliency image

result_ptr = open('result/csiq_contrast_result.txt', 'wt')
